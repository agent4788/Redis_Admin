...
public class ListPaneController {
    ...
    void clickAddMenuItem(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/List/ListEntryAddDialog.fxml"));
            ...
            dialog.getIcons().add(new Image(ListPaneController.class.getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/add.png")));
    ...
    void clickEditMenuItem(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/List/ListEntryEditDialog.fxml"));
            Parent root = loader.load();
            ...
            dialog.initOwner(RedisAdmin.getPrimaryStage());
            Scene scene = new Scene(root, 500, 400);
            dialog.getIcons().add(new Image(ListPaneController.class.getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/edit.png")));
            dialog.setScene(scene);
