...
public class ListEntryEditDialogController {
    ...
    void initialize() {
        assert valueTextField != null : "fx:id=\"valueTextField\" was not injected: check your FXML file 'ListEntryEditDialog.fxml'.";
        assert cancleButton != null : "fx:id=\"cancleButton\" was not injected: check your FXML file 'ListEntryEditDialog.fxml'.";
