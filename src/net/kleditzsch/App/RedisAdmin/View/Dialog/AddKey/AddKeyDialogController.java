package net.kleditzsch.App.RedisAdmin.View.Dialog.AddKey;
...
public class AddKeyDialogController {
    ...
    void initialize() {
        ...
        try {
            ...
            defaultRoot = FXMLLoader.load(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/String/StringForm.fxml"));
            ...
            try {
                ...
                switch (newValue.toString()) {
                    ...
                    case "String":
                        ...
                        //String Formular
                        fxmlFile = "/net/kleditzsch/App/RedisAdmin/View/Dialog/String/StringForm.fxml";
                    ...
                    case "Hash":
                        ...
                        //Hash Formular
                        fxmlFile = "/net/kleditzsch/App/RedisAdmin/View/Dialog/Hash/HashForm.fxml";
                        root = FXMLLoader.load(getClass().getResource(fxmlFile));
                        layout.setCenter(root);
                        break;
                    case "List":
                        ...
                        //List Formular
                        fxmlFile = "/net/kleditzsch/App/RedisAdmin/View/Dialog/List/ListForm.fxml";
                        root = FXMLLoader.load(getClass().getResource(fxmlFile));
                        layout.setCenter(root);
                        break;
                    case "Set":
                        ...
                        //Set Formular
                        fxmlFile = "/net/kleditzsch/App/RedisAdmin/View/Dialog/Set/SetForm.fxml";
                        root = FXMLLoader.load(getClass().getResource(fxmlFile));
                        layout.setCenter(root);
                    break;
                    case "ZSet":
                        ...
                        //ZList Formular
                        fxmlFile = "/net/kleditzsch/App/RedisAdmin/View/Dialog/Zset/ZSetForm.fxml";
                        root = FXMLLoader.load(getClass().getResource(fxmlFile));
                        layout.setCenter(root);
                        break;
                }
