package net.kleditzsch.App.RedisAdmin.View.Dialog.AddKeyView;
/**
...
public class SetFormController {
    ...
    void initialize() {
        assert keyTextField != null : "fx:id=\"keyTextField\" was not injected: check your FXML file 'SetForm.fxml'.";
        assert valueTextArea != null : "fx:id=\"valueTextArea\" was not injected: check your FXML file 'SetForm.fxml'.";
