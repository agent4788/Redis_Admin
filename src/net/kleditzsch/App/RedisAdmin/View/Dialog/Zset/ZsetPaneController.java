...
public class ZsetPaneController {
    ...
    void clickAddMenuItem(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/Zset/ZSetEntryEditDialog.fxml"));
    ...
    void editScoreMenuItem(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/Zset/ZSetEditScoreDialog.fxml"));
            Parent root = loader.load();
            ...
            dialog.getIcons().add(new Image(ZsetPaneController.class.getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/edit.png")));
            dialog.setScene(scene);
            dialog.setTitle("ZSet Eintrag erstellen");
            dialog.showAndWait();
