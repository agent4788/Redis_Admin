...
public class HashPaneController {
    ...
    void clickAddMenuItem(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/Hash/HashEntryEditDialog.fxml"));
            ...
            dialog.getIcons().add(new Image(HashPaneController.class.getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/add.png")));
    ...
    void clickEditMenuItem(ActionEvent event) {
        ...
        try {
            ...
            dialog.initOwner(RedisAdmin.getPrimaryStage());
            Scene scene = new Scene(root, 500, 400);
            dialog.getIcons().add(new Image(HashPaneController.class.getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/edit.png")));
            dialog.setScene(scene);
            dialog.setTitle("Hash Eintrag bearbeiten");
            dialog.showAndWait();
