package net.kleditzsch.App.RedisAdmin.View.Dialog.RedisAdmin;
...
import net.kleditzsch.App.RedisAdmin.Controller.Backup.BackupExport;
import net.kleditzsch.App.RedisAdmin.Controller.Backup.BackupImport;
import net.kleditzsch.App.RedisAdmin.Model.KeyTreeViewModel;
...
import net.kleditzsch.App.RedisAdmin.View.Dialog.Hash.HashPaneController;
import net.kleditzsch.App.RedisAdmin.View.Dialog.List.ListPaneController;
import net.kleditzsch.App.RedisAdmin.View.Dialog.Set.SetPaneController;
import net.kleditzsch.App.RedisAdmin.View.Dialog.Settings.SettingsDialogController;
import net.kleditzsch.App.RedisAdmin.View.Dialog.String.StringPaneController;
import net.kleditzsch.App.RedisAdmin.View.Dialog.Zset.ZsetPaneController;
...
public class RedisAdminController {
    ...
    void clickAboutMenuItem(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/About/AboutDialog.fxml"));
            ...
            dialog.getIcons().add(new Image(RedisAdminController.class.getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/help.png")));
    ...
    void clickSettingsMenuItem(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/Settings/SettingsDialog.fxml"));
            Parent root = loader.load();
            ...
            dialog.getIcons().add(new Image(RedisAdminController.class.getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/settings.png")));
            dialog.setScene(scene);
    ...
    void clickAddKeyMenuItem(ActionEvent event) {
        ...
        try {
            ...
            dialog.getIcons().add(new Image(RedisAdminController.class.getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/add.png")));
            dialog.setScene(scene);
                    ...
                    try {
                        ...
                        switch (type) {
                            ...
                            case "string":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/String/StringPane.fxml"));
                                root = loader.load();
                            ...
                            case "hash":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/Hash/HashPane.fxml"));
                                root = loader.load();
                            ...
                            case "list":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/List/ListPane.fxml"));
                                root = loader.load();
                            ...
                            case "set":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/Set/SetPane.fxml"));
                                root = loader.load();
                            ...
                            case "zset":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/Zset/ZsetPane.fxml"));
                                root = loader.load();
    ...
    protected void showServerInfo() {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/net/kleditzsch/App/RedisAdmin/View/Dialog/ServerInfo/ServerInfo.fxml"));
            Parent root = loader.load();
            keyView.setCenter(root);
        } catch (IOException ex) {
