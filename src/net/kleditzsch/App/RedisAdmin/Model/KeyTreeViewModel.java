...
public class KeyTreeViewModel {
    ...
    public TreeItem<String> getKeyList() {
        ...
        //Icons
        Node database = new ImageView(new Image(getClass().getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/database.png")));
        Image folderImage = new Image(getClass().getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/folder.png"));
        Image dataImage = new Image(getClass().getResourceAsStream("/net/kleditzsch/App/RedisAdmin/View/resource/data.png"));
