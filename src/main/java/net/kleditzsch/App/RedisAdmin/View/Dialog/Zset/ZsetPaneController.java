...
public class ZsetPaneController {
    ...
    void editScoreMenuItem(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/ZSetEditScoreDialog.fxml"));
            Parent root = loader.load();
            ...
            dialog.getIcons().add(new Image(ZsetPaneController.class.getResourceAsStream("/icon/edit.png")));
            dialog.setScene(scene);
            dialog.setTitle("ZSet Eintrag erstellen");
            dialog.showAndWait();
