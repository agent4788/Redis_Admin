...
public class AddKeyDialogController {
    ...
    void initialize() {
        ...
        try {
            ...
            defaultRoot = FXMLLoader.load(getClass().getResource("/fxml/StringForm.fxml"));
