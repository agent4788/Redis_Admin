...
public class SetPaneController {
    ...
    void clickAddMenuItem(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/SetEntryEditDialog.fxml"));
            ...
            dialog.getIcons().add(new Image(SetPaneController.class.getResourceAsStream("/icon/add.png")));
