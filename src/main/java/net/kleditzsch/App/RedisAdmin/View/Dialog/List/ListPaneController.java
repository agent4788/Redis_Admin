...
public class ListPaneController {
    ...
    void clickAddMenuItem(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/ListEntryAddDialog.fxml"));
            ...
            dialog.getIcons().add(new Image(ListPaneController.class.getResourceAsStream("/icon/add.png")));
    ...
    void clickEditMenuItem(ActionEvent event) {
        ...
        try {
            ...
            dialog.initOwner(RedisAdmin.getPrimaryStage());
            Scene scene = new Scene(root, 500, 400);
            dialog.getIcons().add(new Image(ListPaneController.class.getResourceAsStream("/icon/edit.png")));
            dialog.setScene(scene);
