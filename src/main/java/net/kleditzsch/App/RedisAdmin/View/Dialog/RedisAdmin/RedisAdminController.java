...
public class RedisAdminController {
    ...
    void clickAboutMenuItem(ActionEvent event) {
        try {
            ...
            dialog.getIcons().add(new Image(RedisAdminController.class.getResourceAsStream("/icon/help.png")));
    ...
    void clickSettingsMenuItem(ActionEvent event) {
        ...
        try {
            ...
            dialog.getIcons().add(new Image(RedisAdminController.class.getResourceAsStream("/icon/settings.png")));
            dialog.setScene(scene);
    ...
    void clickAddKeyMenuItem(ActionEvent event) {
        ...
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/AddKeyDialog.fxml"));
            ...
            dialog.getIcons().add(new Image(RedisAdminController.class.getResourceAsStream("/icon/add.png")));
            dialog.setScene(scene);
                    ...
                    try {
                        ...
                        switch (type) {
                            ...
                            case "string":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/fxml/StringPane.fxml"));
                                root = loader.load();
                            ...
                            case "hash":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/fxml/HashPane.fxml"));
                                root = loader.load();
                            ...
                            case "list":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/fxml/ListPane.fxml"));
                                root = loader.load();
                            ...
                            case "set":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/fxml/SetPane.fxml"));
                                root = loader.load();
                            ...
                            case "zset":
                                ...
                                loader = new FXMLLoader(getClass().getResource("/fxml/ZsetPane.fxml"));
                                root = loader.load();
